...
TEST(CanBusTestGroup, readCanTemperaturePidTest)
{
    /*arrange*/
...
TEST(CanBusTestGroup, read_can_supported_pid)
{
    /*arrange*/
     struct cloud_data_struct cloud_data;
     //struct can_frame = (struct )"0";



   /*act*/
   read_can_supported_pid(&cloud_data);



   /*assert*/
    //CHECK_EQUAL(1, supportedframe);
    CHECK(cloud_data.can_data.supported_pids[0] >= 0);
}



TEST(CanBusTestGroup, read_can_speed_pid)
{
    /*arrange*/
    struct cloud_data_struct cloud_data;
...
TEST(CanBusTestGroup, read_can_rpm_pid)
{
    /*arrange*/
    struct cloud_data_struct cloud_data;
   /*act*/
    read_can_supported_pid(&cloud_data);
   /*assert*/
    CHECK(cloud_data.can_data.rpm >= 0 );
}

TEST(CanBusTestGroup, read_can_id_number)
{
	/*arrange*/
	struct cloud_data_struct cloud_data;
	...
	/*assert*/
/*	CHECK(cloud_data.can_data.vin >= 0);*/
}
